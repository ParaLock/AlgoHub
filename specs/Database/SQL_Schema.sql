...
ALTER TABLE classification ADD CONSTRAINT classification_parent_id_fk FOREIGN KEY (parent_id) REFERENCES classification (id);
...
ALTER TABLE algorithm ADD CONSTRAINT algorithm_classification_id_fk FOREIGN KEY (classification_id) REFERENCES classification (id);
...
ALTER TABLE implementation ADD CONSTRAINT implementation_algorithm_id_fk FOREIGN KEY (algorithm_id) REFERENCES algorithm (id);
...
ALTER TABLE problem_instance ADD CONSTRAINT problem_instance_algorithm_id_fk FOREIGN KEY (algorithm_id) REFERENCES algorithm (id);
